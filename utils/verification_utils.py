...
def validate_text(locator, expected_text: str, description: str = ""):
    try:
        ...
        logger.error(f"[FAIL] {description or locator} | Validation failed: {e} | Expected: '{expected_text}' | Screenshot: {path} | Video: {video_path}")
        raise
...
def validate_visible(locator, description: str = ""):
    try:
        ...
        video_path = get_video_path(locator.page)
        logger.error(f"[FAIL] {description or locator} | Visibility validation failed: {e} | Screenshot: {path} | Video: {video_path}")
        raise
...
def validate_not_visible(locator, description: str = ""):
    try:
        ...
        video_path = get_video_path(locator.page)
        logger.error(f"[FAIL] {description or locator} | Not visible validation failed: {e} | Screenshot: {path} | Video: {video_path}")
        raise
...
def validate_checkbox_checked(locator, description: str = ""):
    try:
        ...
        video_path = get_video_path(locator.page)
        logger.error(f"[FAIL] {description or locator} | Checked validation failed: {e} | Screenshot: {path} | Video: {video_path}")
        raise
...
def validate_checkbox_unchecked(locator, description: str = ""):
    try:
        ...
        video_path = get_video_path(locator.page)
        logger.error(f"[FAIL] {description or locator} | Unchecked validation failed: {e} | Screenshot: {path} | Video: {video_path}")
        raise
